...
rule all_plots:
    input:
        ...
        gnomad_loss        = "plots/results_gnomad_loss" + config["FIG_FORMAT"],
        gnomad_gain        = "plots/results_gnomad_gain" + config["FIG_FORMAT"],
...
rule gnomad_plots:
    input:
        ...
        model = "results/ISV_{cnv_type}.json",
    output:
        gnomad = "plots/results_gnomad_{cnv_type}" + config["FIG_FORMAT"]
    script:
